...
use CULabs\jQueryBundle\Twig\Node\DialogNode;

class DialogTokenParser extends \Twig_TokenParser
{
    /**
    ...
    public function parse(\Twig_Token $token)
    {
        ...
        $body = $this->parser->subparse(function (\Twig_Token $token) { 
            return $token->test(array('endjqdialog'));
        }, true);
        
        $this->parser->getStream()->expect(\Twig_Token::BLOCK_END_TYPE);
        return new DialogNode($body, $js_name, $jq_config, $lineno, $this->getTag());
    }
